...
1. Download the <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.5.1.min.js" download>latest build</a>.
...
3. `IcecastMetadataPlayer` is made available as a global variable in your webpage to use wherever.
   ...
   **Example**
   ...
   ```html
   <script src="icecast-metadata-player-1.5.1.min.js"></script>
   <script>
...
* To enable the source map, simply copy `icecast-metadata-player-1.5.1.min.js.map` located in the build folder of this project to the location along side `icecast-metadata-player-1.5.1.min.js` in your website.
