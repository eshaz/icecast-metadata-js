...
1. Download all of the files <a href="https://github.com/eshaz/icecast-metadata-js/tree/master/src/icecast-metadata-player/build">here</a> for the latest build and save these to a path on your server.
   ...
   * The `*.js.map` files are optional source maps for debugging.
     ...
     | - | - |
     | <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.15.1.main.min.js" download>`icecast-metadata-player-1.15.1.main.min.js`</a> | Core functionality (playback, metadata) <br> **Use this file in your `<script>` tag** |
     | <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.15.1.synaudio.min.js" download>`icecast-metadata-player-1.15.1.synaudio.min.js`</a> | Gapless playback support |
     | <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.15.1.mediasource.min.js" download>`icecast-metadata-player-1.15.1.mediasource.min.js`</a> | Mediasource playback support |
     | <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.15.1.mpeg.min.js" download>`icecast-metadata-player-1.15.1.mpeg.min.js`</a> | MPEG playback support (webaudio) |
     | <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.15.1.flac.min.js" download>`icecast-metadata-player-1.15.1.flac.min.js`</a> | FLAC playback support (webaudio) |
     | <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.15.1.opus.min.js" download>`icecast-metadata-player-1.15.1.opus.min.js`</a> | Opus playback support (webaudio) |
     | <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.15.1.vorbis.min.js" download>`icecast-metadata-player-1.15.1.vorbis.min.js`</a> | Vorbis playback support (webaudio) |
     | <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.15.1.common.min.js" download>`icecast-metadata-player-1.15.1.common.min.js`</a> | Common functions (webaudio) |
2. Add a `<script>` tag referencing `icecast-metadata-player-1.15.1.main.min.js` in your html.
3. `IcecastMetadataPlayer` is made available as a global variable in your webpage to use wherever.

   **Example**

   ```html
   <script src="icecast-metadata-player-1.15.1.main.min.js"></script>
   <script>
...
* To enable the source map, simply copy `icecast-metadata-player-1.15.1.min.js.map` located in the build folder of this project to the location along side `icecast-metadata-player-1.15.1.min.js` in your website.
