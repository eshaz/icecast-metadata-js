...
1. Download the <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-player/build/icecast-metadata-player-1.1.0.min.js" download>latest build</a>.
...
* To enable the source map, simply copy `icecast-metadata-player-1.1.0.min.js.map` located in the build folder of this project to the location along side `icecast-metadata-player-1.1.0.min.js` in your website.
