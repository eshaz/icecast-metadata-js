...
export default class FragmentedISOBMFFBuilder {
          ...
          boxes: [
            ...
            new Box("mdia", {
              boxes: [
                new Box("mdhd", {
                  /* prettier-ignore */
                  contents: [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xac,0x44,0x00,0x00,0x00,0x00,0x55,0xc4,0x00,0x00],
                }),
                new Box("hdlr", {
                  /* prettier-ignore */
   ...
   */
  static get mp3MovieBox() {
    return Uint8Array.from([
      ...FragmentedISOBMFFBuilder.ftyp.mp3.contents,
      ...FragmentedISOBMFFBuilder.moov.mp3.contents,
    ]);
  }
