...
class IcecastMetadataRecorder {
  ...
  _getCueBuilder() {
    ...
    this._cueBuilder = new CueBuilder(
      {
        comment: "Generated by IcecastMetadataRecorder https://github.com/eshaz/icecast-metadata-js",
        title: this._name || name, // TODO: Remove name requirement in args so we can default to icecast headers
        ...icyHeaders,
  ...
  _recordMetadata(meta) {
    ...
    this._cueBuilder.addTrack(
      {
        title: `${timeStamp} ${StreamTitle}`, // TODO: Add argument to opt-in to dates being prepended to the title
        ...restOfMetadata,
      },
