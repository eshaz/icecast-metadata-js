...
1. Download the <a href="https://raw.githubusercontent.com/eshaz/icecast-metadata-js/master/src/icecast-metadata-stats/build/icecast-metadata-stats-0.1.0.min.js" download>latest build</a>.
...
3. `IcecastMetadataStats` is made available as a global variable in your webpage to use wherever.
   ...
   **Example**
   ...
   ```html
   <script src="icecast-metadata-stats-0.1.0.min.js"></script>
   <script>
     const onStats = (stats) => {
...
* To enable the source map, simply copy `icecast-metadata-stats-0.1.0.min.js.map` located in the build folder of this project to the location along side `icecast-metadata-stats-0.1.0.min.js` in your website.
